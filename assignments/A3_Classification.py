# ============================================================
# Logistic_Regression_From_Scratch_With_Boundary
# ============================================================
# 1. IMPORT LIBRARIES
# ============================================================
import numpy as np
...
# ============================================================
# 2. CREATE BINARY CLASSIFICATION TRAINING DATA
# ============================================================
...
# ============================================================
# 3. CREATE BOOLEAN MASKS FOR CLASS 0 AND CLASS 1
# ============================================================
one = y_train == 1
zero = y_train == 0
...
# ============================================================
# 5. VISUALIZE INITIAL DECISION BOUNDARY
# x0 + x1 = 2.75
# ============================================================
one = y_train == 1
zero = y_train == 0
...
# ============================================================
# 8. COMPUTE LOGISTIC REGRESSION GRADIENTS
# ============================================================
...
# ============================================================
# 12. TEST MODEL WITH INPUT [1.5, 2]
# ============================================================
x_test = np.array([1.5,2])

z_tmp = np.dot(x_test, w_out) + b_out
y_test = sigmoid(z_tmp)

print(f'y prediction is {y_test}')

# ============================================================
# 13. CLASSIFY USING 0.5 THRESHOLD
# ============================================================
if y_test >= 0.5:
  print('y = 1')
else:
...
# ============================================================
# 14. VISUALIZE DECISION BOUNDARY AND TEST INPUT
# ============================================================
one = y_train == 1
zero = y_train == 0
...
plt.scatter(x_test[0], x_test[1], color='g', label='(1.5, 2) Test input', marker='o')
