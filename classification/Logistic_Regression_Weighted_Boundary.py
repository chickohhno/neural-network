...
# ============================================================
# 6. VISUALIZE DATA WITH WEIGHTED DECISION BOUNDARY
# Decision Boundary: 0.5*Exam1 + Exam2 - 100 = 0
# Therefore: Exam2 = 100 - 0.5*Exam1
# ============================================================
one = y_train == 1
zero = y_train == 0
...
# ============================================================
# 9. TEST CASE 1 / MAKE PASS-FAIL CLASSIFICATION
# ============================================================
x_test = [50, 50]
w = np.array([0.5, 1])
b = -100
...
# ============================================================
# 10. TEST CASE 2 / MAKE PASS-FAIL CLASSIFICATION
# ============================================================
x_test = [40, 60]
w = np.array([0.5, 1])
b = -100
